...
class Thermometer extends Component {
	...
	graph(min, max, current) {
		...
		tubeWidth = 32.25,
		tubeBorderWidth = 1,
		mercuryColor = "rgb(153,0,0)",
		innerBulbColor = "rgb(51, 0, 0)"
...
[minTemp, maxTemp].forEach((t) => {
	...
	var isMax = (t == maxTemp),
	label = (isMax ? "Max: " + max.toFixed(2) : "Min: " + min.toFixed(2)),
	textCol = (isMax ? "#990000" : "#337ab7"),
...
renderTitle(){
	if (this.props.abbr !== null && this.props.img !== null){
